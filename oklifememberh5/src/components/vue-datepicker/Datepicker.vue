<template>
    <div class="date-picker" >
      <div class="input-wrapper">
        <div  class="input" @click.stop="togglePanel" v-text="value ? '':(range ? value[0] + '-' + value[1] : value)"></div>
      </div>
      ...
      <div class="modal" v-show="panelState" @click.stop="modalhide"></div>
    </div>
</template>
        ...
        filters: {
            ...
            month: (item, lang) => {
                switch (lang) {
                    ...
                    case 'ch':
                        return {1: '1月', 2: '2月', 3: '3月', 4: '4月', 5: '5月', 6: '6月',
                         7: '7月', 8: '8月', 9: '9月', 10: '10月', 11: '11月', 12: '12月'}[item]
                    case 'uk':
